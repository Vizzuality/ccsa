...
export const getGetLayersQueryOptions = <TData = Awaited<ReturnType<typeof getLayers>>, TError = ErrorType<Error>>(params?: GetLayersParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getLayers>>, TError, TData>, request?: SecondParameter<typeof API>}
) => {
...
export const useGetLayers = <TData = Awaited<ReturnType<typeof getLayers>>, TError = ErrorType<Error>>(
 params?: GetLayersParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getLayers>>, TError, TData>, request?: SecondParameter<typeof API>}
...
export const getGetLayersIdQueryOptions = <TData = Awaited<ReturnType<typeof getLayersId>>, TError = ErrorType<Error>>(id: number,
    params?: GetLayersIdParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getLayersId>>, TError, TData>, request?: SecondParameter<typeof API>}
) => {
