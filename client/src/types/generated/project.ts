...
export const getGetProjectsQueryOptions = <TData = Awaited<ReturnType<typeof getProjects>>, TError = ErrorType<Error>>(params?: GetProjectsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getProjects>>, TError, TData>, request?: SecondParameter<typeof API>}
) => {
...
export const useGetProjects = <TData = Awaited<ReturnType<typeof getProjects>>, TError = ErrorType<Error>>(
 params?: GetProjectsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getProjects>>, TError, TData>, request?: SecondParameter<typeof API>}
...
export const getPostProjectsMutationOptions = <TError = ErrorType<Error>,
    ...
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postProjects>>, TError,{data: ProjectRequest}, TContext>, request?: SecondParameter<typeof API>}
...
export const getGetProjectsIdQueryOptions = <TData = Awaited<ReturnType<typeof getProjectsId>>, TError = ErrorType<Error>>(id: number,
    params?: GetProjectsIdParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getProjectsId>>, TError, TData>, request?: SecondParameter<typeof API>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetProjectsIdQueryKey(id,params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getProjectsId>>> = ({ signal }) => getProjectsId(id,params, requestOptions, signal);

      

      

   return  { queryKey, queryFn, enabled: !!(id), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getProjectsId>>, TError, TData> & { queryKey: QueryKey }
}
...
export const getPutProjectsIdMutationOptions = <TError = ErrorType<Error>,
    ...
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof putProjectsId>>, TError,{id: number;data: ProjectRequest}, TContext>, request?: SecondParameter<typeof API>}
...
export const getDeleteProjectsIdMutationOptions = <TError = ErrorType<Error>,
    ...
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteProjectsId>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof API>}
